...
import dataset_scripts.tforms as tforms
from dataset_scripts.datasets_utils import combine_for_replay_all
...
def call_dataset_holdout_w_validation(dset_name, data_dir, experiment_dir, experiment_filepath=None, experiment_name=None, 
    ...
    if dset_name=='cifar10':
        import dataset_scripts.cifar10_dataset as dset
        total_classes=10
        obj2class={}
        for i in range(0,10):
            obj2class[i]=i
        ...
        import dataset_scripts.cifar100_dataset as dset
        total_classes=100
        ...
        import dataset_scripts.emnist_dataset as dset
        target_ind = 1
        ...
        import dataset_scripts.inaturalist_dataset as dset
        target_ind = 1
