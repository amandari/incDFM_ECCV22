...
# def evaluate_simple_CL_test(t, novelty_detector, noveltyResults_test, params_score, incomming_loader):
...
def evaluate_simple_CL(t, novelty_detector, noveltyResults, params_score, incomming_loader, novelty_detector_name):
    ...
    if novelty_detector_name=='softmax':
